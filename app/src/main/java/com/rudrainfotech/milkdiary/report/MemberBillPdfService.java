...
//
///**
// * Member bill + cap PDFs with i18n and Marathi digits.
// * Marathi words (labels/headers) are drawn with Java2D shaping into the cell at layout time,
// * fixing clusters like "प् रकार" → "प्रकार" and "ल ि" → "लि".
// */
//public class MemberBillPdfService {
//
//    /* =========================
...
//    private static class DayRow {
//        java.time.LocalDate date;
//        BigDecimal amQty = BigDecimal.ZERO;
//        BigDecimal amAmt = BigDecimal.ZERO;
//        BigDecimal pmQty = BigDecimal.ZERO;
//        BigDecimal pmAmt = BigDecimal.ZERO;
//    }
//    private static class MemberCapData {
//        java.util.List<DayRow> rows = new java.util.ArrayList<>();
//        BigDecimal amTotalQty = BigDecimal.ZERO;
//        BigDecimal pmTotalQty = BigDecimal.ZERO;
//
//        BigDecimal totalQty  = BigDecimal.ZERO;
//        BigDecimal totalAmt  = BigDecimal.ZERO;
//
//        BigDecimal fatQty = BigDecimal.ZERO; // fat% * qty
//        BigDecimal snfQty = BigDecimal.ZERO; // snf% * qty
//
//        BigDecimal buffaloQty = BigDecimal.ZERO;
//        BigDecimal cowQty     = BigDecimal.ZERO;
//
//        BigDecimal avgFat; // set later
//        BigDecimal avgSnf; // set later
//        BigDecimal gross;  // = totalAmt (2)
//        BigDecimal roundOff;
//        BigDecimal net;
//    }
//    private static class BillDayRow {
...
//            return BaseFont.createFont(
//                    tmp.toString(),
//                    BaseFont.IDENTITY_H,   // keep Identity-H; numbers remain real glyphs
//                    BaseFont.EMBEDDED
//            );
//        } catch (Exception e) {
//            throw new RuntimeException("Failed to load font: " + resourcePath, e);
...
//    }
//    private static String capTitle(int start, int end) {
//        String pat = I18n.t("bill.cap.days");
//        if (pat == null || pat.isBlank()) pat = "Days {0}–{1}";
//        return pat.replace("{0}", toLocalDigits(Integer.toString(start)))
//                .replace("{1}", toLocalDigits(Integer.toString(end)));
//    }
//
//    /* =========================
...
//            """).formatted(where);
//
//        java.util.List<Object[]> members = Tx.tx(s -> {
//            var q = s.createQuery(hql, Object[].class).setParameter("oid", outletId);
//            if (speciesFilter != null) q.setParameter("sp", speciesFilter);
//            return q.getResultList();
//        });
...
//            var bf  = devanagariBaseFont();
//            var bfb = devanagariBaseFontBold();
//            com.lowagie.text.Font headF  = new com.lowagie.text.Font(bfb, 9);
//            com.lowagie.text.Font baseF  = new com.lowagie.text.Font(bf,  8);
//            com.lowagie.text.Font smallF = new com.lowagie.text.Font(bf,  7);
//            com.lowagie.text.Font boldF  = new com.lowagie.text.Font(bfb, 8);
//
//            int perPage = 3, onPage = 0;
//
//            for (Object[] row : members) {
...
//                Species mSpecies = (Species) row[3];
//
//                java.util.List<DailyMilkEntry> entries = Tx.tx(s ->
//                        s.createQuery("""
//                            from DailyMilkEntry e
//                            where e.outlet.id=:oid and e.member.id=:mid and e.date between :sd and :ed
//                            order by e.date asc, e.session asc
...
//        }
//
//        java.util.List<BillDayRow> cap1 = buildCap(byDate, ym,  1, 10, fillMissingDays);
//        java.util.List<BillDayRow> cap2 = buildCap(byDate, ym, 11, 20, fillMissingDays);
//        java.util.List<BillDayRow> cap3 = buildCap(byDate, ym, 21, ym.lengthOfMonth(), fillMissingDays);
//
//        CapSummary s1 = summarize(cap1);
//        CapSummary s2 = summarize(cap2);
//        CapSummary s3 = summarize(cap3);
...
//            var bf  = devanagariBaseFont();
//            var bfb = devanagariBaseFontBold();
//            com.lowagie.text.Font h1    = new com.lowagie.text.Font(bfb, 12);
//            com.lowagie.text.Font h2    = new com.lowagie.text.Font(bfb, 10);
//            com.lowagie.text.Font base  = new com.lowagie.text.Font(bf,   9);
//            com.lowagie.text.Font small = new com.lowagie.text.Font(bf,   8);
//            com.lowagie.text.Font bold  = new com.lowagie.text.Font(bfb,  9);
//
//            // Title (Paragraph is fine; problematic items are handled via shaped cells below)
//            Paragraph title = new Paragraph(o.getName() == null ? I18n.t("app.title") : o.getName(), h1);
//            title.setAlignment(Element.ALIGN_CENTER);
//            doc.add(title);
//
...
//            PdfPTable info = new PdfPTable(new float[]{28, 36, 18, 18});
//            info.setWidthPercentage(100);
//            addKV(writer, info, I18n.t("bill.header.member"), m.getCode() + " - " + nvl(m.getName()), base);
//            addKV(writer, info, I18n.t("bill.header.period"), toLocalDigits(String.format("%04d-%02d", year, month)), base);
//            addKV(writer, info, I18n.t("bill.header.billNo"), nvl(bill.getBillNo()), base);
//            addKV(writer, info, I18n.t("bill.header.date"), fmtDate(java.time.LocalDate.now()), base);
//            doc.add(info);
//            doc.add(Chunk.NEWLINE);
//
//            // Three caps vertically
//            doc.add(capTable(writer, capTitle(1, 10),   cap1, s1, h2, base, small, bold));
//            doc.add(Chunk.NEWLINE);
//            doc.add(capTable(writer, capTitle(11, 20),  cap2, s2, h2, base, small, bold));
//            doc.add(Chunk.NEWLINE);
//            doc.add(capTable(writer, capTitle(21, ym.lengthOfMonth()), cap3, s3, h2, base, small, bold));
//            doc.add(Chunk.NEWLINE);
//
//            // Totals
//            PdfPTable totals = new PdfPTable(new float[]{60, 40});
//            totals.setWidthPercentage(60);
//            totals.setHorizontalAlignment(Element.ALIGN_RIGHT);
//            addKV(writer, totals, I18n.t("bill.footer.gross"),       fmt2(nz(bill.getGrossAmount())), bold);
//            addKV(writer, totals, I18n.t("bill.footer.adjustments"), fmt2(nz(bill.getAdjustmentsTotal())), base);
//            addKV(writer, totals, I18n.t("bill.footer.roundOff"),    fmt2(nz(bill.getRoundOff())), base);
//
//            PdfPCell netK = shapedOrPhraseCell(writer, I18n.t("bill.footer.net"), bold, true, new Color(255,255,255), Element.ALIGN_LEFT, 3f);
//            netK.setBorder(Rectangle.TOP);
//            PdfPCell netV = new PdfPCell(new Phrase(fmt2(nz(bill.getNetAmount())), bold));
//            netV.setHorizontalAlignment(Element.ALIGN_RIGHT);
//            netV.setBorder(Rectangle.TOP);
...
//       ========================= */
//
//    private MemberCapData buildMemberCapData(java.util.List<DailyMilkEntry> entries,
//                                             YearMonth ym,
//                                             int d1, int d2,
//                                             boolean fillMissingDays) {
//
...
//        MemberCapData data = new MemberCapData();
//        data.rows = map.values().stream()
//                .sorted(java.util.Comparator.comparing(r -> r.date))
//                .toList();
//
//        for (DailyMilkEntry e : entries) {
//            BigDecimal q = nz(e.getQtyLitre());
...
//                                      String memberCode,
//                                      String memberName,
//                                      String speciesLabel, // localized
//                                      java.time.LocalDate start,
//                                      java.time.LocalDate end,
//                                      MemberCapData data,
//                                      com.lowagie.text.Font headF,
//                                      com.lowagie.text.Font baseF,
//                                      com.lowagie.text.Font smallF,
//                                      com.lowagie.text.Font boldF,
//                                      PdfWriter writer) {
//
//        String printedBy = new AppSettingsService()
//                .getString(AppSettingsService.PRINTED_BY, System.getProperty("user.name","user"));
...
//        PdfPTable hdrRow1 = new PdfPTable(new float[]{55, 45});
//        hdrRow1.setWidthPercentage(100);
//        hdrRow1.addCell(slab(writer, I18n.t("bill.header.outlet"),
//                (o.getName()==null ? I18n.t("app.title") : o.getName()), headF, boldF, hbg));
//        hdrRow1.addCell(slab(writer, I18n.t("bill.header.member"),
//                memberCode + " - " + (memberName==null?"":memberName), headF, boldF, hbg));
//        outer.addCell(hdrRow1);
//
//        // Row 2
//        PdfPTable hdrRow2 = new PdfPTable(new float[]{14, 20, 66});
//        hdrRow2.setWidthPercentage(100);
//        hdrRow2.addCell(slab(writer, I18n.t("bill.header.type"),      speciesLabel, baseF, baseF, hbg));
//        hdrRow2.addCell(slab(writer, I18n.t("bill.header.printedBy"), printedBy,    baseF, baseF, hbg));
//        hdrRow2.addCell(slab(writer, I18n.t("bill.header.span"),
//                fmtDate(start) + " – " + fmtDate(end), baseF, baseF, hbg));
//        outer.addCell(hdrRow2);
//
//        // Table
//        PdfPTable t = new PdfPTable(new float[]{16, 12, 12, 12, 12, 14, 22});
//        t.setWidthPercentage(100);
//        header(writer, t, I18n.t("bill.col.date"),  boldF);
//        header(writer, t, I18n.t("bill.col.amQty"), boldF);
//        header(writer, t, I18n.t("bill.col.amRate"),boldF);
//        header(writer, t, I18n.t("bill.col.pmQty"), boldF);
//        header(writer, t, I18n.t("bill.col.pmRate"),boldF);
//        header(writer, t, I18n.t("bill.col.qty"),   boldF);
//        header(writer, t, I18n.t("bill.col.amount"),boldF);
//
//        for (DayRow r : data.rows) {
//            BigDecimal dayQty = r.amQty.add(r.pmQty);
//            BigDecimal dayAmt = r.amAmt.add(r.pmAmt);
...
//        summary.setWidthPercentage(100);
//        Color bg = new Color(245,245,245);
//        summary.addCell(slab(writer, I18n.t("bill.footer.litre"),    fmt3(data.totalQty), baseF, boldF, bg));
//        summary.addCell(slab(writer, I18n.t("bill.footer.avgFat"),   data.avgFat==null? "" : data.avgFat.setScale(2, RoundingMode.HALF_UP).toPlainString(), baseF, boldF, bg));
//        summary.addCell(slab(writer, I18n.t("bill.footer.avgSnf"),   data.avgSnf==null? "" : data.avgSnf.setScale(2, RoundingMode.HALF_UP).toPlainString(), baseF, boldF, bg));
//        summary.addCell(slab(writer, I18n.t("bill.footer.gross"),    fmt2(data.gross), baseF, boldF, bg));
//        summary.addCell(slab(writer, I18n.t("bill.footer.roundOff"), fmt2(data.roundOff), baseF, boldF, bg));
//        summary.addCell(slab(writer, I18n.t("bill.footer.net"),      fmt2(data.net), baseF, boldF, bg));
//
//        outer.addCell(summary);
//        return outer;
//    }
//
//    private java.util.List<BillDayRow> buildCap(
//            Map<java.time.LocalDate, BillDayRow> byDate,
//            YearMonth ym,
//            int startDayInclusive,
//            int endDayInclusive,
...
//        }
//
//        java.util.List<BillDayRow> out = new ArrayList<>();
//        for (int d = startDayInclusive; d <= last; d++) {
//            java.time.LocalDate dt = ym.atDay(d);
//            BillDayRow r = byDate.get(dt);
//            if (r == null) {
...
//    }
//
//    private CapSummary summarize(java.util.List<BillDayRow> rows) {
//        CapSummary s = new CapSummary();
//        BigDecimal fatQty = BigDecimal.ZERO, snfQty = BigDecimal.ZERO;
//        for (BillDayRow r : rows) {
//            s.litre = s.litre.add(nz(r.qty));
...
//    }
//
//    private PdfPTable capTable(PdfWriter writer,
//                               String title,
//                               java.util.List<BillDayRow> rows,
//                               CapSummary sum,
//                               com.lowagie.text.Font capTitle,
//                               com.lowagie.text.Font base,
//                               com.lowagie.text.Font small,
//                               com.lowagie.text.Font headerBold) {
//        PdfPTable outer = new PdfPTable(1);
//        outer.setWidthPercentage(100);
//
//        PdfPCell cap = shapedOrPhraseCell(writer, title, capTitle, true, new Color(240,240,240), Element.ALIGN_LEFT, 3f);
//        outer.addCell(cap);
//
//        PdfPTable t = new PdfPTable(new float[]{22, 20, 24, 34}); // Date, Qty, Rate, Amount
//        t.setWidthPercentage(100);
//        header(writer, t, I18n.t("bill.col.date"),  headerBold);
//        header(writer, t, I18n.t("bill.col.qty"),   headerBold);
//        header(writer, t, I18n.t("bill.col.rate"),  headerBold);
//        header(writer, t, I18n.t("bill.col.amount"),headerBold);
//
//        for (BillDayRow r : rows) {
//            t.addCell(cell(small, fmtDate(r.date)));
//            t.addCell(cellRight(small, fmt3(r.qty)));
...
//        PdfPTable s = new PdfPTable(new float[]{32, 68});
//        s.setWidthPercentage(100);
//        PdfPCell k = shapedOrPhraseCell(writer, I18n.t("bill.header.period"), base, false, new Color(245,245,245), Element.ALIGN_LEFT, 3f);
//        PdfPCell v = shapedOrPhraseCell(writer,
//                I18n.t("bill.footer.litre") + ": " + fmt3(sum.litre) +
//                        "   " + I18n.t("bill.footer.avgFat") + ": " + nv2(sum.avgFat) +
//                        "   " + I18n.t("bill.footer.avgSnf") + ": " + nv2(sum.avgSnf) +
//                        "   " + I18n.t("bill.col.amount") + ": " + fmt2(sum.amount),
//                base, false, new Color(245,245,245), Element.ALIGN_LEFT, 3f);
//        s.addCell(k); s.addCell(v);
//
//        outer.addCell(s);
//        return outer;
...
//
//    /* =========================
//       PDF cell helpers (shaped)
//       ========================= */
//
//    /** add key|value row; shaped for Marathi to fix ligatures. */
//    private static void addKV(PdfWriter w, PdfPTable t, String k, String v, com.lowagie.text.Font f) {
//        if (isMr()) {
//            PdfPCell ck = shapedOrPhraseCell(w, k, f, false, null, Element.ALIGN_LEFT, 2f);
//            PdfPCell cv = shapedOrPhraseCell(w, toLocalDigits(v), f, true,  null, Element.ALIGN_RIGHT, 2f);
//            ck.setBorder(Rectangle.NO_BORDER); cv.setBorder(Rectangle.NO_BORDER);
//            t.addCell(ck); t.addCell(cv);
//        } else {
//            PdfPCell ck = new PdfPCell(new Phrase(k, f));
//            ck.setBorder(Rectangle.NO_BORDER);
//            PdfPCell cv = new PdfPCell(new Phrase(toLocalDigits(v), f));
//            cv.setHorizontalAlignment(Element.ALIGN_RIGHT);
//            cv.setBorder(Rectangle.NO_BORDER);
//            t.addCell(ck); t.addCell(cv);
//        }
//    }
//
//    private static PdfPCell cell(com.lowagie.text.Font f, String s){
//        PdfPCell c = new PdfPCell(new Phrase(s==null?"":s, f));
//        c.setPadding(2);
//        return c;
//    }
//    private static PdfPCell cellRight(com.lowagie.text.Font f, String s){
//        PdfPCell c = cell(f, s);
//        c.setHorizontalAlignment(Element.ALIGN_RIGHT);
//        return c;
//    }
//
//    private static void header(PdfWriter w, PdfPTable t, String s, com.lowagie.text.Font headerFont){
//        if (isMr()) {
//            PdfPCell c = shapedOrPhraseCell(w, s, headerFont, true, new Color(235,235,235), Element.ALIGN_CENTER, 3f);
//            t.addCell(c);
//        } else {
//            PdfPCell c = new PdfPCell(new Phrase(s, headerFont));
//            c.setBackgroundColor(new Color(235,235,235));
...
//    }
//
//    // compact 2-col key|value slab with bg and right-aligned value.
//    private static PdfPCell slab(
//            PdfWriter w,
//            String k,
//            String v,
//            com.lowagie.text.Font keyFont,
//            com.lowagie.text.Font valFont,
//            Color bg
//    ) {
//        PdfPTable t = new PdfPTable(new float[]{50, 50});
//        t.setWidthPercentage(100);
//
//        PdfPCell ck = shapedOrPhraseCell(w, k == null ? "" : k, keyFont, false, bg, Element.ALIGN_LEFT, 2f);
//        PdfPCell cv = shapedOrPhraseCell(w, toLocalDigits(v == null ? "" : v), valFont, true,  bg, Element.ALIGN_RIGHT, 2f);
//
//        ck.setBorder(Rectangle.NO_BORDER);
//        cv.setBorder(Rectangle.NO_BORDER);
//        t.addCell(ck); t.addCell(cv);
...
//
//    /* =========================
//       Java2D shaping (draws at final cell size)
//       ========================= */
//
//    private static java.awt.Font AWT_DEV_REG, AWT_DEV_BOLD;
//
//    private static synchronized java.awt.Font awtDev(boolean bold, float pt) {
//        try {
//            if (AWT_DEV_REG == null) {
//                try (java.io.InputStream is = MemberBillPdfService.class.getResourceAsStream("/fonts/NotoSansDevanagari-Regular.ttf")) {
//                    AWT_DEV_REG = java.awt.Font.createFont(java.awt.Font.TRUETYPE_FONT, is);
//                }
//            }
//            if (AWT_DEV_BOLD == null) {
//                try (java.io.InputStream is = MemberBillPdfService.class.getResourceAsStream("/fonts/NotoSansDevanagari-Bold.ttf")) {
//                    AWT_DEV_BOLD = java.awt.Font.createFont(java.awt.Font.TRUETYPE_FONT, is);
//                }
//            }
//            return (bold ? AWT_DEV_BOLD : AWT_DEV_REG).deriveFont(pt);
//        } catch (Exception e) {
//            throw new RuntimeException("Failed to init AWT Devanagari fonts", e);
//        }
//    }
//
//    private static class ShapedTextCellEvent implements PdfPCellEvent {
...
//        @Override
//        public void cellLayout(PdfPCell cell, Rectangle rect, PdfContentByte[] canvases) {
//            if (!isMr()) return; // non-Marathi path uses normal Phrase rendering
//
//            // Size of THIS cell (template space starts at 0,0)
//            final float w = Math.max(1f, rect.getWidth());
//            final float h = Math.max(1f, rect.getHeight());
//
//            PdfContentByte cb = canvases[PdfPTable.TEXTCANVAS];
...
//
//                // Font + paint
//                java.awt.Font font = awtDev(bold, fontPt);
//                g2.setFont(font);
//                g2.setPaint(java.awt.Color.BLACK);
//
//                // All coordinates BELOW are in template space [0..w]×[0..h]
//                final float availW = Math.max(1f, w - 2*paddingPt);
//                final float x0 = paddingPt;
//                float y = paddingPt; // draw bottom→top (PDF y grows up)
//
//                // Shape + wrap Marathi text
//                AttributedString as = new AttributedString(text);
//                as.addAttribute(TextAttribute.FONT, font);
//                as.addAttribute(TextAttribute.LANGUAGE, new java.util.Locale("mr","IN"));
//                AttributedCharacterIterator it = as.getIterator();
//
//                FontRenderContext frc = g2.getFontRenderContext();
//                LineBreakMeasurer lbm = new LineBreakMeasurer(
//                        it, BreakIterator.getLineInstance(new java.util.Locale("mr","IN")), frc);
//
//                final int end = it.getEndIndex();
//                while (lbm.getPosition() < end) {
//                    TextLayout layout = lbm.nextLayout(availW);
...
//
//                    y += layout.getDescent() + layout.getLeading();
//                    if (y > h - paddingPt) break; // don't overflow cell
//                }
//            } finally {
//                g2.dispose();
//            }
//
//            // Stamp shaped text at the cell's absolute position on the page
//            Image img;
//            try { img = Image.getInstance(tp); }
//            catch (Exception e) { throw new RuntimeException(e); }
//            img.setAbsolutePosition(rect.getLeft(), rect.getBottom());
//            try { cb.addImage(img); } catch (DocumentException ignore) {}
//        }
//    }
//
//    /** Returns a shaped cell (for mr) or a normal Phrase cell (others). */
//    private static PdfPCell shapedOrPhraseCell(PdfWriter w,
//                                               String text,
...
//            c.setBorder(Rectangle.NO_BORDER);
//            c.setPadding(paddingPt);
//            c.setCellEvent(new ShapedTextCellEvent(text, f.getSize(), boldLook, hAlign, paddingPt));
//            // sensible minimum so row isn't collapsed
//            c.setMinimumHeight(Math.max(14f, f.getSize() + 6f + 2*paddingPt));
//            return c;
//        } else {
...
//            var bf  = devanagariBaseFont();
//            var bfb = devanagariBaseFontBold();
//            Font headF  = new Font(bfb, 9);
//            Font baseF  = new Font(bf,  8);
//            Font smallF = new Font(bf,  7);
//            Font boldF  = new Font(bfb, 8);
//
//            int perPage = 3, onPage = 0;
//
//            for (Object[] row : members) {
...
//        PdfPTable hdrRow1 = new PdfPTable(new float[]{55, 45});
//        hdrRow1.setWidthPercentage(100);
//        hdrRow1.addCell(slab(I18n.t("bill.header.outlet"),
//                (o.getName()==null ? I18n.t("app.title") : o.getName()), headF, boldF, hbg));
//        hdrRow1.addCell(slab(I18n.t("bill.header.member"),
//                memberCode + " - " + (memberName==null?"":memberName), headF, boldF, hbg));
//        outer.addCell(hdrRow1);
//
//        // Row 2
//        PdfPTable hdrRow2 = new PdfPTable(new float[]{14, 20, 66});
//        hdrRow2.setWidthPercentage(100);
//        hdrRow2.addCell(slab(I18n.t("bill.header.type"),      speciesLabel, baseF, baseF, hbg));
//        hdrRow2.addCell(slab(I18n.t("bill.header.printedBy"), printedBy,    baseF, baseF, hbg));
//        hdrRow2.addCell(slab(I18n.t("bill.header.span"),
//                fmtDate(start) + " – " + fmtDate(end), baseF, baseF, hbg));
//        outer.addCell(hdrRow2);
//
//        // Table
...
//        summary.setWidthPercentage(100);
//        Color bg = new Color(245,245,245);
//        summary.addCell(slab(I18n.t("bill.footer.litre"),    fmt3(data.totalQty), baseF, boldF, bg));
//        summary.addCell(slab(I18n.t("bill.footer.avgFat"),   data.avgFat==null? "" : data.avgFat.setScale(2, RoundingMode.HALF_UP).toPlainString(), baseF, boldF, bg));
//        summary.addCell(slab(I18n.t("bill.footer.avgSnf"),   data.avgSnf==null? "" : data.avgSnf.setScale(2, RoundingMode.HALF_UP).toPlainString(), baseF, boldF, bg));
//        summary.addCell(slab(I18n.t("bill.footer.gross"),    fmt2(data.gross), baseF, boldF, bg));
//        summary.addCell(slab(I18n.t("bill.footer.roundOff"), fmt2(data.roundOff), baseF, boldF, bg));
//        summary.addCell(slab(I18n.t("bill.footer.net"),      fmt2(data.net), baseF, boldF, bg));
//
//        outer.addCell(summary);
//        return outer;
//    }
...
//        PdfPTable s = new PdfPTable(new float[]{32, 68});
//        s.setWidthPercentage(100);
//        PdfPCell k = new PdfPCell(new Phrase(I18n.t("bill.header.period"), base)); // label area; reusing a neutral key
//        k.setBackgroundColor(new Color(245,245,245));
//        k.setPadding(3);
//        PdfPCell v = new PdfPCell(new Phrase(
//                I18n.t("bill.footer.litre") + ": " + fmt3(sum.litre) +
...
//
//    // A compact 2-col key|value cell with background and right-aligned value.
//    private static com.lowagie.text.pdf.PdfPCell slab(
//            String k,
//            String v,
//            com.lowagie.text.Font keyFont,
//            com.lowagie.text.Font valFont,
//            java.awt.Color bg
//    ) {
//        com.lowagie.text.pdf.PdfPTable t = new com.lowagie.text.pdf.PdfPTable(new float[]{50, 50});
//        t.setWidthPercentage(100);
//
//        com.lowagie.text.pdf.PdfPCell ck = new com.lowagie.text.pdf.PdfPCell(
//                new com.lowagie.text.Phrase(k == null ? "" : k, keyFont));
//        com.lowagie.text.pdf.PdfPCell cv = new com.lowagie.text.pdf.PdfPCell(
//                new com.lowagie.text.Phrase(toLocalDigits(v == null ? "" : v), valFont));
//
//        ck.setBackgroundColor(bg);
//        cv.setBackgroundColor(bg);
//        ck.setBorder(com.lowagie.text.Rectangle.NO_BORDER);
...
//        t.addCell(cv);
//
//        com.lowagie.text.pdf.PdfPCell outer = new com.lowagie.text.pdf.PdfPCell(t);
//        outer.setPadding(0);
//        outer.setBackgroundColor(bg);
//        outer.setBorder(com.lowagie.text.Rectangle.NO_BORDER); // keep header slab borderless
//        return outer;
//    }
//}
